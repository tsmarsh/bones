...
help:
	...
	@echo "  lineedit         - Run LLM line editor (style/consistency review)"
	@echo "  copyedit         - Run LLM copy editor (grammar edits, saved to git branch)"
...
# ===================== Modular Includes =====================
# AI editing tools (lineedit, copyedit)
include $(BONES_HOME)scripts/ai-editing.mk

# Project initialization scaffolding (init, update-workflows, and all .git/chapters/etc targets)
include $(BONES_HOME)scripts/init.mk